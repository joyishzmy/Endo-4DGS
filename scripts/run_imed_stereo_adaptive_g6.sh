...
OUT_ROOT="${REPO_ROOT}/output/ablation/stereo_adaptive_g6"
CONFIG="arguments/imed_extent10_principal_stereo_adaptive_g6_iter2500.py"
PORT="${IMED_PORT:-6046}"
SEED="${IMED_SEED:-1}"
...
for seq in "${seqs[@]}"; do
    for control in \
        ...
        "output/ablation/stereo_appearance_g5/$seq/results.json"
    do
...
"${PYTHON_BIN}" scripts/compare_imed_stereo_adaptive_g6.py
echo "Adaptive-reliability stereo G6 pilot completed."
