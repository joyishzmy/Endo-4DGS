...
CONTROL_ROOT = Path("output/ablation/stereo_principal_v2")
G3_ROOT = Path("output/ablation/stereo_photogate_g3")
SEQUENCES = ["session_004_scene_6_tool_3", "session_007_scene_5_tool_2"]
METHOD_PATHS = {
    "baseline_pp": CONTROL_ROOT / "baseline_pp",
    "g2v2_rgb": CONTROL_ROOT / "g2v2_rgb",
    "g3_photogate": G3_ROOT,
}
...
for method in ("g2v2_rgb", "g3_photogate"):
    deltas = {
        metric: sum(
